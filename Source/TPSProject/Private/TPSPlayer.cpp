...
void ATPSPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (EnhancedPlayerInputComponent != nullptr) {
		...
		EnhancedPlayerInputComponent->BindAction(IA_tpsJump, ETriggerEvent::Started, this, &ATPSPlayer::Jump);
		EnhancedPlayerInputComponent->BindAction(IA_tpsJump, ETriggerEvent::Completed, this, &ATPSPlayer::StopJumping);
